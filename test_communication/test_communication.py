...
class Test_communication:
    ...
    def test_communication_empty(self):
        ...
        namesurname = WebDriverWait(self.driver,10).until(ec.visibility_of_element_located((By.XPATH,gc.NAMESURNAME_X )))
        message = namesurname.text == 'Doldurulması zorunlu alan*'
        print(f"Name Surname Message : {message}")
        sleep(2)
        
        email = WebDriverWait(self.driver,10).until(ec.visibility_of_element_located((By.XPATH,gc.EMAIL_X )))
        message = email.text == 'Doldurulması zorunlu alan*'
        print(f"Email Message : {message}")
        sleep(2)
        
        message = WebDriverWait(self.driver,10).until(ec.visibility_of_element_located((By.XPATH,gc.MESSAGE_X )))
